...
router.post('/:id/media', requireAuth, verifyCsrf, uploadMedia.single('file'), uploadProjectMedia);
router.put('/:id/media/reorder', requireAuth, verifyCsrf, reorderProjectMedia);
router.put('/:id/media/:mediaId', requireAuth, verifyCsrf, updateProjectMedia);
router.delete('/:id/media/:mediaId', requireAuth, verifyCsrf, deleteProjectMedia);
