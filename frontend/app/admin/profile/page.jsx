      ...
      <div className="glass rounded-2xl p-6 space-y-6 max-w-3xl">
        ...
        <div>
          ...
          <textarea
            ...
            value={profile.bio ?? ''}
            onChange={handleChange}
            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-accent-light transition-colors resize-none"
          />
        </div>
